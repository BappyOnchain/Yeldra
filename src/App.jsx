...
const YELDRA_LOGO = 'https://i.postimg.cc/nhSSNc9S/IMG-20260702-175620.png'
...
const appKit = createAppKit({
  ...
  metadata: {
    name: 'Yeldra',
    description: 'Yeldra — Professional DeFi Staking Protocol',
    ...
    >
      <div className="flex items-center justify-between px-6 py-6">
        <div className="flex items-center gap-2.5">
          ...
          />
          <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-cyan-400 to-violet-500 items-center justify-center font-bold text-dark-bg text-sm hidden">
            Y
          </div>
          <span className="font-semibold text-lg tracking-tight">Yeldra</span>
        </div>
